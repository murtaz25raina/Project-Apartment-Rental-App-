		...
		<form role="form" name="form" method="post" action="InfoAdd" onsubmit="return validate()">
			<fieldset>
				...
				<div class="form-group">
                    <input type="text" name="Name" class="form-control input-lg" placeholder="Enter Your Name" minlength=4 required>
				</div>
				<div class="form-group">
                    <input type="email" name="email" class="form-control input-lg" placeholder="Email Address" required>
				</div>
				<div class="form-group">
                    <input type="Password" name="password" class="form-control input-lg" placeholder="Password" minlength=6 required>
				</div>
				<div class="form-group">
                    <input type="password" name="confirm" class="form-control input-lg" placeholder="Confirm Password">
				</div>
				<div class="form-group">
                    <input type="tel" name="phone" class="form-control input-lg" placeholder="Phone Number" minlength=10 maxlength=10 required>
				</div>
				<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-xs-6 col-sm-6 col-md-6">
						<a href="LogIn.jsp" class="btn btn-lg btn-primary btn-block">Log In</a>
					</div>
				</div>
			</fieldset>
		</form>
