...
public final class ListingofOwned_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<ListingBean> ar20 = (ArrayList<ListingBean>)request.getAttribute("GodOne"); 
      ...
      out.write("            {\n");
      out.write("                var yes2 = document.formi.APi2.value;\n");
      out.write("                \n");
      out.write("                var yes = document.formi.APi.value;\n");
      out.write("                console.log(yes);\n");
      out.write("                if(yes2!==\"Request\")\n");
      out.write("                {\n");
      out.write("                    alert(\"Request Already Approved\");\n");
      out.write("                    return false;\n");
      out.write("                }\n");
      out.write("                else{\n");
      out.write("                 if (yes === \"No\")\n");
      out.write("                {\n");
      out.write("                    alert(\"There are currently no requests for this Apartment\");\n");
      out.write("                    return false;\n");
      out.write("                }\n");
      out.write("            }\n");
      out.write("            }\n");
      ...
      out.write("            {\n");
      out.write("                    var yes3 = document.formi10.APi3.value;\n");
      out.write("            \n");
      out.write("                if (yes3 === \"No\")\n");
      out.write("                {\n");
      out.write("                    alert(\"There are currently no requests for this Apartment\");\n");
      out.write("                    return false;\n");
      out.write("                }\n");
  ...
  if(!ar2.isEmpty()){
      ...
      out.write("\n");
      out.write("          <center><h3 class=\"rainbow\"> You Have Reached The End of This Section.</h3></center>\n");
      out.write("          <hr class=\"colorgraph\">\n");
      out.write("      <center><h3 class=\"rainbow\"> My Apartment(s).</h3></center>\n");
      out.write("    <hr class=\"colorgraph\">\n");
      out.write("      ");
  if(!ar20.isEmpty()){
      ...
      out.write("      <div style=\"height:300px;\" id=\"lol\">\n");
      out.write("       <a href=");
      out.print( ar20.get(i).getImgLink());
      out.write(" target=\"_blank\" >\n");
      out.write("           <img src=");
      out.print( ar20.get(i).getImgLink());
      out.write(" width=\"300\" height=\"300\" style=\"float:left;margin:0 20px 20px 0;\"> </a>\n");
      out.write("      <p style=\"color:#9C27B0;\">Email :");
      out.print( ar20.get(i).getUserEmail());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">State :");
      out.print( ar20.get(i).getState());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">Address :");
      out.print( ar20.get(i).getAddress());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">Bedrooms :");
      out.print( ar20.get(i).getBedrooms());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">Requested By :");
      out.print( ar20.get(i).getRequestedBy());
      out.write("</p>\n");
      out.write("      <div class=\"row\">\n");
      out.write("      <form method=\"post\" name=\"formi\" action=\"ApproveRequest\" onsubmit=\"return validate()\">\n");
      out.write("          <input type=\"hidden\" name=\"APi\" value=");
      out.print(ar20.get(i).getRequestedBy());
      out.write(" >\n");
      out.write("          <input type=\"hidden\" name=\"APi2\" value=");
      out.print(ar20.get(i).getRequestStatus());
      out.write(" >\n");
      out.write("          <input type=\"hidden\" name=\"APD\" value=");
      out.print(ar20.get(i).getApId());
      out.write(" >\n");
      out.write("          <button type=\"submit\" class=\"btn btn-success\">Approve Request</button>\n");
      out.write("      <!--<input type=\"submit\" value=\"Approve Request\">--></form>\n");
      out.write("      <form method=\"post\" name=\"formi10\" action=\"RejectRequest\" onsubmit=\"return func()\">\n");
      out.write("          <input type=\"hidden\" name=\"APi3\" value=");
      out.print(ar20.get(i).getRequestedBy());
      out.write(" >\n");
      out.write("          <input type=\"hidden\" name=\"lol\" value=");
      out.print(ar20.get(i).getApId());
      out.write(" >\n");
      out.write("          <button type=\"submit\" class=\"btn btn-danger\">Reject Request</button>\n");
      out.write("          <!-- <input type=\"submit\" value=\"Reject Request\">--></form></div>\n");
      out.write("      </div>\n");
      out.write("      <hr class=\"colorgraph\">\n");
      out.write("      ");
}}
